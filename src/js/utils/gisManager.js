...
function geoJsonMultiLineStringCoordsToSingleLineStringCoords(srcCoords) {
...
module.exports = {
  arraysEquals: arraysEquals,
  arrays_intersection: arrays_intersection,
  geoJsonMultiLineStringCoordsToSingleLineStringCoords: geoJsonMultiLineStringCoordsToSingleLineStringCoords
}
